...
私もその一人です。「Xは仕事です」この一言で新しくアカウントを作成しましたが、顔となるアイコンをよく考えずに決めてしまっていました。
...
## ■ サービスの差別化ポイント・推しポイント
画像生成系のサービスはすでに多く存在しています。(代表例：[canva](https://www.canva.com/ja_jp/))
### ・円形のアイコンに特化した画像生成
あいこん屋は、SNSプロフィールなどでよく使われる円形のアイコンに特化しています。この特化により、ユーザーはSNS等で使用するためのアイコンを簡単に作成できます。
また、テイストもSNS用のアイコンに向いているデザインが選択できます。

### ・みんなのアイコン一覧を通じたアイデアの共有
他のユーザーが作ったアイコン一覧機能を見て新しいアイデアを得ることができます。現状ある画像生成系のサービスにはない差別化ポイントになります。
