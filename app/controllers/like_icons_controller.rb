class LikeIconsController < ApplicationController
  def index
    post_icon_like_icons = current_user.post_icon_like_icons.all.includes(:user)
    created_icon_like_icons = current_user.created_icon_like_icons.all.includes(:user)
