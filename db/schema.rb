...
ActiveRecord::Schema[7.0].define(version: 2024_04_07_093705) do
  ...
  create_table "post_icons", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "status", default: 0, null: false
    t.index ["user_id", "created_at"], name: "index_post_icons_on_user_id_and_created_at"
    t.index ["user_id"], name: "index_post_icons_on_user_id"
  end
  ...
  add_foreign_key "created_icons", "users"
  add_foreign_key "post_icons", "users"
end
